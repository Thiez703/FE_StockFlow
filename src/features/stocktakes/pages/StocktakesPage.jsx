...
import { Button, Input, Select, Segmented, Tag, App } from 'antd';
import {
  PlusOutlined,
  SearchOutlined,
  CheckOutlined,
        ...
        actions={
          ...
          detailRecord?.status === 'PENDING' && (
            <>
              <Button
                icon={<CheckOutlined />}
                onClick={() => setStatusOf(detailRecord.id, 'APPROVED', 'Đã duyệt phiếu kiểm kê')}
              >
                Duyệt
              </Button>
              <Button
                danger
                icon={<CloseOutlined />}
                onClick={() => setStatusOf(detailRecord.id, 'REJECTED', 'Đã từ chối phiếu kiểm kê')}
              >
                Từ chối
              </Button>
            </>
