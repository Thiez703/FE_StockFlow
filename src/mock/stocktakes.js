...
export const STOCKTAKES = [
  {
    ...
    status: 'PENDING', createdBy: 'Lê Minh Quân', note: 'Kiểm kê định kỳ khu A',
    items: [
  ...
  },
  {
    ...
    status: 'APPROVED', createdBy: 'Võ Đức Huy', note: '',
    items: [
  ...
  },
  {
    ...
    status: 'REJECTED', createdBy: 'Phạm Thu Hà', note: 'Số liệu chưa khớp, kiểm lại',
    items: [
  ...
  },
  {
    ...
    status: 'APPROVED', createdBy: 'Lê Minh Quân', note: '',
    items: [
